...
ALTER TABLE "user"
    ADD CONSTRAINT fk_user_creator_id FOREIGN KEY (creator_id) REFERENCES "user" (id),
    ADD CONSTRAINT fk_user_updater_id FOREIGN KEY (updater_id) REFERENCES "user" (id);
...
ALTER TABLE role
    ADD CONSTRAINT fk_role_creator_id FOREIGN KEY (creator_id) REFERENCES "user" (id),
    ADD CONSTRAINT fk_role_updater_id FOREIGN KEY (updater_id) REFERENCES "user" (id);
...
ALTER TABLE menu
    ...
    ADD CONSTRAINT fk_menu_creator_id FOREIGN KEY (creator_id) REFERENCES "user" (id),
    ADD CONSTRAINT fk_menu_updater_id FOREIGN KEY (updater_id) REFERENCES "user" (id);
...
ALTER TABLE dept
    ...
    ADD CONSTRAINT fk_dept_creator_id FOREIGN KEY (creator_id) REFERENCES "user" (id),
    ADD CONSTRAINT fk_dept_updater_id FOREIGN KEY (updater_id) REFERENCES "user" (id);
ALTER TABLE "user"
...
ALTER TABLE user_role_mapping
    ADD CONSTRAINT fk_user_role_mapping_user_id FOREIGN KEY (user_id) REFERENCES "user" (id),
